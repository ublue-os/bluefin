...
RUN wget https://copr.fedorainfracloud.org/coprs/rhcontainerbot/bootc/repo/fedora-"${FEDORA_MAJOR_VERSION}"/rhcontainerbot-bootc-fedora-"${FEDORA_MAJOR_VERSION}".repo
