...
if [[ "${AKMODS_FLAVOR}" == "coreos" ]]; then
    rpm-ostree override replace --experimental \
        ...
        "https://kojipkgs.fedoraproject.org//packages/kernel/$KERNEL_MAJOR_MINOR_PATCH/$KERNEL_RELEASE/x86_64/kernel-headers-$KERNEL_MAJOR_MINOR_PATCH-$KERNEL_RELEASE.x86_64.rpm" \
