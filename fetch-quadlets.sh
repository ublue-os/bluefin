...
# finite-cli
wget --output-document="/usr/etc/containers/systemd/users/finite-cli.container" --quiet https://raw.githubusercontent.com/ublue-os/toolboxes/main/quadlets/finite-cli/finite-cli.container 
cat /usr/share/ublue-os/finite-cli/ptyxis-integration >> /usr/etc/containers/systemd/users/finite-cli.container
printf "\n\n[Install]\nWantedBy=finite-cli.target" >> /usr/etc/containers/systemd/users/finite-cli.container
sed -i '/AutoUpdate.*/ s/^#*/#/' /usr/etc/containers/systemd/users/finite-cli.container
sed -i 's/ContainerName=finite/ContainerName=finite-cli/' /usr/etc/containers/systemd/users/finite-cli.container

# finite-dx-cli
wget --output-document="/usr/etc/containers/systemd/users/finite-dx-cli.container" --quiet https://raw.githubusercontent.com/ublue-os/toolboxes/main/quadlets/finite-cli/finite-dx-cli.container 
cat /usr/share/ublue-os/finite-cli/ptyxis-integration >> /usr/etc/containers/systemd/users/finite-dx-cli.container
...
cat /usr/share/ublue-os/finite-cli/ptyxis-integration >> /usr/etc/containers/systemd/users/fedora-toolbox.container
...
cat /usr/share/ublue-os/finite-cli/ptyxis-integration >> /usr/etc/containers/systemd/users/ubuntu-toolbox.container
...
cat /usr/share/ublue-os/finite-cli/ptyxis-integration >> /usr/etc/containers/systemd/users/wolfi-toolbox.container
...
cat /usr/share/ublue-os/finite-cli/ptyxis-integration >> /usr/etc/containers/systemd/users/wolfi-dx-toolbox.container
...
mkdir -p /usr/share/ublue-os/finite-cli
QUADLET_TARGETS=(
    "finite-cli"
    "finite-dx-cli"
    "fedora-toolbox"
...
cat > "/usr/share/ublue-os/finite-cli/${i}.sh" <<EOF
#!/bin/sh 
